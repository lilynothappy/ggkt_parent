package com.lynn.ggkt.wechat.service.impl;


import com.lynn.ggkt.client.course.CourseFeignClient;
import com.lynn.ggkt.model.vod.Course;
import com.lynn.ggkt.wechat.service.MessageService;
...
public class MessageServiceImpl implements MessageService {
    ...
    public void pushPayMessage(long id) {
        //微信openid
        String openid = "oyfPl5s7cP6fAlRniMXiRHGVAOuA";
        WxMpTemplateMessage templateMessage = WxMpTemplateMessage.builder()
                .toUser(openid)//要推送的用户openid
                .templateId("wtEXrvM24hOPZiJS2yvbmPsXZEe5sJ62GvABDv5bVhs")//模板id
                .url("https://55n78370f8.goho.co/#/pay/"+id)//点击模板消息要访问的网址
                .build();
