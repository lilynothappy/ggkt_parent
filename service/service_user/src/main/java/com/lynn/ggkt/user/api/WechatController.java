    ...
    public String userInfo(@RequestParam("code") String code,
        ...
        try {
            ...
            if(userInfo == null){
                ...
                userInfo.setAvatar(wxMpUser.getHeadImgUrl()); //头像
            ...
            //授权完成后跳转到具体功能页面
            //生成token，按一定规则生成字符串，可以包含用户信息
            String token = JwtHelper.createToken(userInfo.getId(),userInfo.getNickName());

            //判断returnUrl内是否含有其他参数
            if(!returnUrl.contains("?")){  //returnUrl.indexOf("?") == -1
